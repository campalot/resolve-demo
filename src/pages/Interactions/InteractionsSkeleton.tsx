    ...
    <section>
      ...
      <div className={styles.paginationBar}>
        <nav className={styles.pagination}>
          <div
            className={skeletonStyles.pagination}
          />
        </nav>
      </div>
      <Toolbar>
        ...
        <Toolbar.Bottom>
          <div
            className={skeletonStyles.status}
          />
          <div
            className={skeletonStyles.dateRange}
          />
        </Toolbar.Bottom>
      </Toolbar>
            ...
            <div className={styles.rowLink} style={{ cursor: "default" }}>
              <div className={styles.main}>
                <div className={styles.titleRow}>
                  ...
                  {/* Badge Skeleton */}
                  <div
                    className={skeletonStyles.badge}
                  />
                </div>
                <div className={styles.meta}>
                  {/* Meta text line */}
                  <div
                    className={skeletonStyles.textLine}
                  />
                </div>
              </div>
